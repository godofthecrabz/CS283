...
EOF
    ...
    expected_output="assignment_tests.shstudent_tests.shlocalmodedsh4>dsh4>dsh4>cmdloopreturned0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="7localmodedsh4>dsh4>cmdloopreturned0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="hello,classhowareyoutoday?localmodedsh4>dsh4>dsh4>dsh4>cmdloopreturned0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="testredirectioninlocalmodedsh4>dsh4>cmdloopreturned0"
